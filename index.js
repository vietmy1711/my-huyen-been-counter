...
function updateClock() {
  ...
  if (newDate.getDate() == startDateTime.getDate()) {
    if (newDate.getMonth() == startDateTime.getMonth()) {
      ...
      document.getElementById("time-elapsed").innerHTML = totalYear;
      ...
      document.getElementById("time-elapsed").innerHTML = totalMonth;
      document.getElementById("unit-type").innerHTML =
  ...
  document.getElementById("time-elapsed").innerHTML = d;
